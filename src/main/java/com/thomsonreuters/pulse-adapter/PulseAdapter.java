/* Elektron Pulse Streaming Adapter.
 */
...
/* Instrument list. */
	...
	private static Logger LOG = LogManager.getLogger (PulseAdapter.class.getName());
	...
	private static void printHelp (Options options) {
		new HelpFormatter().printHelp ("PulseAdapter", options);
	}
 ...
 */
	private class ShutdownThread extends Thread {
		...
		public ShutdownThread (PulseAdapter adapter) {
...
/* Prevent new events being generated whilst shutting down. */
	...
	public static void main (String[] args) throws Exception {
		final Options options = PulseAdapter.buildOptions();
		final CommandLine line = new PosixParser().parse (options, args);
		PulseAdapter adapter = new PulseAdapter();
